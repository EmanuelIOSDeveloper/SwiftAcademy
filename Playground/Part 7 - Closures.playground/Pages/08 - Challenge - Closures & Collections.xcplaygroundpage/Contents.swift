...
let classPets = students.compactMap {
    $0.pet
}

//OU

let classPets_1 = students.compactMap { student in
    student.pet
}
...
let classLibraryBooks_1 = students.flatMap { student in
    student.libraryBooks
}
print(classLibraryBooks_1)
